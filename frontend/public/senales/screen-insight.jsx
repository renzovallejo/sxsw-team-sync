// Insight screen — 3 layout variants
// The "chispa intelectual" returned in Parte 1 of the prompt

// ── Variant A: Editorial card ────────────────────────────────
function InsightEditorial({ signal, accent, typeSys, onOpen, onNewSignal }) {
  return (
    <div style={{
...
function InsightOraculo({ signal, accent, typeSys, onOpen, onNewSignal }) {
  return (
    <div style={{
      position: 'absolute', inset: 0, background: PAPER, color: INK,
      fontFamily: typeSys.body,
...
function InsightFieldTool({ signal, accent, typeSys, onOpen, onNewSignal }) {
  const line = (k, v) => (
...
window.InsightEditorial = InsightEditorial;
window.InsightOraculo = InsightOraculo;
window.InsightFieldTool = InsightFieldTool;
