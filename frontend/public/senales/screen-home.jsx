...
function HomeScreen({ signals, accent, typeSys, onCapture, onOpenSignal, onOpenFeed, onOpenMap, onOpenNotifications }) {
...
function TabBar({ active, onTab, onCaptureSheet, accent, typeSys }) {
  return (
    <div style={{
...
function CaptureSheet({ accent, typeSys, onPick, onClose }) {
  return (
