...
function FuturosScreen({ signals, accent, typeSys, onOpenSignal }) {
...
function ScenarioVisual({ kind, accent }) {
  if (kind === 'climate') {
    // Sun + heat haze; sombrillas grid as silhouettes
    return (
      <div style={{
  ...
  if (kind === 'ghost') {
    // Dark gradient with floating soundwave + portrait silhouette
    return (
      <div style={{
        height: 160, position: 'relative', overflow: 'hidden',
  ...
  if (kind === 'civic') {
    // Grid of "cuadras" — each block a tiny system icon
    return (
      <div style={{
        height: 160, position: 'relative', overflow: 'hidden',
  ...
  if (kind === 'distributed') {
    // Network — nodes connected by lines, drifting
    return (
      <div style={{
        height: 160, position: 'relative', overflow: 'hidden',
...
window.FuturosScreen = FuturosScreen;
