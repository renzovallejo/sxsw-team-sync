// Small shared atoms used across screens
const { useState, useEffect, useRef } = React;

// Placeholder image: subtle striped SVG, captioned with mono text
function Placeholder({ label, ratio = '4/5', tone = '#D7CFC0', stripe = '#CABE AA', style = {}, dark = false }) {
...
function TipoTag({ tipo, small = false, accent }) {
...
function DisruptionMeter({ level = 3, accent = '#C8462C', size = 'sm' }) {
...
function SignalImage({ kind, style = {}, dark = false }) {
  const labels = {
...
Object.assign(window, { Placeholder, TipoTag, DisruptionMeter, Rule, SignalImage });
